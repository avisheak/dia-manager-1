package com.assignment.diamanager.modules.add_reminder;
...
import com.assignment.diamanager.activity.MainActivity;
import com.assignment.diamanager.common.my_validator.MyValidator;
import com.assignment.diamanager.common.permission_management_android6.PermissionUtil;
import com.assignment.diamanager.common.push_appointments_to_calender.PushAppointmentsToCalender;
import com.assignment.diamanager.entity.Reminder;
...
public class AddReminderActivity extends AppCompatActivity  implements TimePickerDialog.OnTimeSetListener,
    ...
    private final List<String> ALL_APP_PERMISSIONS= new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout LLEndDate = (LinearLayout) findViewById(R.id.LLEndDate);
    ...
    private void addEventToCalendar()
    {
        ...
        String sStartDate = dateet.getText().toString();
        String sStartEndDate = enddateet.getText().toString();
      //  sStartTime= timeet.getText().toString();

        String [] arrDate = sStartDate.split("-");
        int yr=Integer.parseInt(arrDate[2]) ;
        int month=Integer.parseInt(arrDate[1])-1 ;
        int day=Integer.parseInt(arrDate[0]) ;

        String [] arrTime = sStartTime.split(":");
        int hr=Integer.parseInt(arrTime[0].toString()) ;
        int mins=Integer.parseInt(arrTime[1].toString()) ;
        ...
        yr=Integer.parseInt(arrDate[2]) ;
        month=Integer.parseInt(arrDate[1])-1 ;
        day=Integer.parseInt(arrDate[0].toString());
        cal.set(yr, month, day, hr, mins);
